<template>
  <div class="container mx-auto flex justify-center gap-8 md:gap-14 lg:gap-28 items-center text-white mb-6 lg:mb-12">
    <div class="space-x-6 md:space-x-8 lg:space-x-20">
    ...
    <div class="space-x-6 md:space-x-8 lg:space-x-20">
      ...
      <NuxtLink to="https://www.linkedin.com/in/adityawarman-dewa-putra/" target="_blank"><Icon name="prime:linkedin" class="cursor-pointer w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8"/></NuxtLink>
    </div>
  </div>
</template>
